...
export default function EnifCTA() {
  return (
    <section id="contact" className="py-32 md:py-48 bg-[#02040A] relative overflow-hidden border-t border-[#38BDF8]/10">
      {/* Deep Space Radial Background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#081A33_0%,#04070D_40%,#02040A_100%)] pointer-events-none z-0" />
      ...
      <div className="max-w-4xl mx-auto px-margin-mobile md:px-margin-desktop text-center relative z-10">
        <motion.h2
          ...
          className="font-display text-5xl md:text-7xl text-white leading-[1.12] tracking-[-0.01em] mb-8"
        >
          Build What Matters.
        </motion.h2>
        <motion.p
