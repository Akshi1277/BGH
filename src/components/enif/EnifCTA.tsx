...
export default function EnifCTA() {
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 md:py-40 bg-[#090D16] relative overflow-hidden border-t border-[#38BDF8]/10">
      {/* Dark Theme Ambient Overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#141B2E_0%,#090D16_60%,#090D16_100%)] pointer-events-none z-0" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-7/12 flex flex-col items-start text-left">
            ...
            <motion.h2
              ...
              className="font-display font-extralight text-4xl sm:text-5xl md:text-6xl text-[#F8FAFC] leading-[1.12] tracking-[-0.03em] mb-6"
            >
