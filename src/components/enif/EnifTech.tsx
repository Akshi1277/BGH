...
export default function EnifTech() {
  return (
    <section className="py-24 md:py-32 bg-[#04070D] border-b border-[#38BDF8]/10 overflow-hidden relative">
      <div className="max-w-[var(--spacing-container-max)] mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        <div className="mb-12 md:mb-16 max-w-2xl text-center mx-auto">
          <motion.h3
            ...
            className="text-[#38BDF8] font-mono-ui text-sm uppercase tracking-widest mb-4 block font-semibold"
          >
            TECHNOLOGY STACK
          </motion.h3>
          <motion.h2
